...
<head>
    ...
    <title>Dashboard Education Gerabah</title>
</head>
<body class="bg-slate-200">
   ...
   <section class="ml-64">
    <div class="container px-5 pb-5">
        <h1 class="py-10 border-b-[1px] ml-2  border-slate-400 ">Dashboard</h1>

        <div class="mt-4">
            <h1 class="text-xl font-semibold pl-3 py-1">Data Pendaftaran Pelatihan</h1>
