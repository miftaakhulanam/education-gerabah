...
if(isset($_POST['simpan'])){
    ...
    $insert = mysqli_query($koneksi,"INSERT INTO pengguna(nama,username,password,telp,email,address,role) VALUES('$nama','$username','".MD5($password)."','$telp','$email','$address','1')");
...
<body class="bg-slate-200">
   ...
   <section class="ml-64">
    <div class="container px-5 pb-5">
        ...
        <div class="mt-4">
            <h1 class="text-xl font-semibold text-center">Tambah Admin</h1>
