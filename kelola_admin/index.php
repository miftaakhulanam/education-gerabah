            ...
            <div class="bg-white rounded-md p-4 m-2">
                <table class="text-center w-full">
                    <tr class="p-3">
                        ...
                        <th class="p-3 text-sm">Username</th>
                        <th class="p-3 text-sm">Telepon</th>
                        <th class="p-3 text-sm">Email</th>
                        <th class="p-3 text-sm">Alamat</th>
                    ...
                    <tr>
                        ...
                        <td class="p-3 text-sm"><?= $data['telp']; ?></td>
                        <td class="p-3 text-sm"><?= $data['email']; ?></td>
                        <td class="p-3 text-sm text-left"><?= $data['address']; ?></td>
                        <td class="p-3 flex gap-x-2">
                            <a href="edit.php?pengguna_id=<?= $data['pengguna_id'];?>" class="inline-block py-2 px-4 bg-green-600 hover:bg-green-700 text-white rounded-md text-sm">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                     <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                                </svg>
                            </a>
                            <a href="hapus.php?pengguna_id=<?= $data['pengguna_id'];?>" class="inline-block py-2 px-4 bg-red-600 hover:bg-red-700 text-white rounded-md text-sm">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
